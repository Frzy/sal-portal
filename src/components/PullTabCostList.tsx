...
interface CostListProps {
  costItems: PullTab.Cost.Item[]
  listRef?: React.MutableRefObject<EnhancedListRef | null>
  onCreate?: () => void
  onDelete?: (items: PullTab.Cost.Item[]) => void
  onEdit?: (item: PullTab.Cost.Item) => void
  onSelectionChange?: (items: PullTab.Cost.Item[]) => void
  title: string
}
export default function CostList({
  ...
  const filterItems = useMemo(() => {
    ...
    return costItems.filter((item: PullTab.Cost.Item): boolean => {
